...
// WithDomain adds the domain to the get DNS records params
func (o *GetDNSRecordsParams) WithDomain(domain string) *GetDNSRecordsParams {
	o.SetDomain(domain)
	return o
}

// SetDomain adds the domain to the get DNS records params
func (o *GetDNSRecordsParams) SetDomain(domain string) {
	o.Domain = domain
}
