...
// WithBody adds the body to the post domains params
func (o *PostDomainsParams) WithBody(body *models.DomainRequest) *PostDomainsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post domains params
func (o *PostDomainsParams) SetBody(body *models.DomainRequest) {
	o.Body = body
}
