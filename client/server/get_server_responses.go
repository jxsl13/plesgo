...
type GetServerOK struct {
	Payload *models.ServerMeta
}

func (o *GetServerOK) Error() string {
	return fmt.Sprintf("[GET /server][%d] getServerOK  %+v", 200, o.Payload)
}
func (o *GetServerOK) GetPayload() *models.ServerMeta {
	return o.Payload
}

func (o *GetServerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ServerMeta)
